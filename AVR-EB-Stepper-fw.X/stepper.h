...
/* Set ADC input */
#define VBUS_ADC                                ADC_MUXPOS_AIN18_gc

/* USER DEFINE CONFIGS*/
/* MOTOR SPECIFIC*/
#define R                  34.0                  /* Motor Windings Resistance  [ohm] */
#define I_OUT              350.0                /* Motor Output Current Limit [mA] */
...
/* BOARD SPECIFIC*/
#define K_VBUS          11.0                    /* Board voltage divider ratio */
#define ADC_VREF        5.00                     /* ADC Voltage Reference */
